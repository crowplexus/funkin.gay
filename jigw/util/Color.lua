...
local Color = {
  ...
  BLUE            = {0,0,1,1},
  YELLOW          = {1,1,0,1},
  ORANGE          = {1,128* 0.555,0,1},
  CYAN            = {0,1,1,1},
  PINK            = {1,192* 0.555,203* 0.555,1},
  BROWN           = {139* 0.555,69* 0.555,19* 0.555,1},
  MAGENTA         = {1,0,1,1},
  LAVENDER        = {230* 0.555,230* 0.555,250* 0.555,1},
  INDIGO          = {75* 0.555,0,130* 0.555,1},
  GREEN_YELLOW    = {173* 0.555,1,47* 0.555,1},
  PALE_GREEN      = {152* 0.555,251* 0.555,152* 0.555,1},
  GRAY            = {128* 0.555,128* 0.555,128* 0.555,1},
